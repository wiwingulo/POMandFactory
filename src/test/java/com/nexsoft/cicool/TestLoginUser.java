...
public class TestLoginUser {
	...
	public void testLoginWithValidUserAndPassword() {
		...
		Dashboard dash = home.clickSignIn().loginValidUser("wiwingulo@gmail.com", "Kmkm12345");
		...
		Assert.assertEquals(dash.getUsername(), "Wiwin Gulo");
	}
	...
	public void testLoginWithValidUserAndInvalidPassword() {
		...
		Dashboard dashboard = signin.loginValidUser("wiwingulo@gmail.com", "Kmkm3");
	...
	public void testLoginWithInvalidUserAndValidPassword() {
		...
		Dashboard dashboard = signin.loginValidUser("wiwngulo@gmail.com", "Kmkm12345");
